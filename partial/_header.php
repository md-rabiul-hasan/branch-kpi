...
<html lang="en">
   ...
   <body class="app sidebar-mini rtl">
      ...
      <header class="app-header">
         ...
         <img src="<?php echo prefix_dot() ?>assets/img/mtb-logo.png" style="width: 193px!important;" class="img-fluid" alt="">
         </a>
      ...
      <aside class="app-sidebar">
         ...
         <ul class="app-menu">
            ...
            <?php if($_SESSION['role'] == "super_admin" || $_SESSION['role'] == "cbo" ) : ?>
            ...
            <?php if($_SESSION['role'] == "super_admin" || $_SESSION['role'] == "cbo" ) : ?>
               ...
               <li class="treeview">
               <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-trophy"></i><span class="app-menu__label">Regions</span><i class="treeview-indicator fa fa-angle-right"></i></a>
               <ul class="treeview-menu">
                  <li><a class="treeview-item" href="<?php echo prefix_dot() ?>region/region_list.php"><i class="icon fa fa-circle-o"></i>Region List</a></li>
                  <li><a class="treeview-item" href="<?php echo prefix_dot() ?>region/region_branch_list.php"><i class="icon fa fa-circle-o"></i>Region Branch</a></li>
               </ul>
               </li>
            <?php endif; ?>

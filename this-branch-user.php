...
<?php 
 ...
 ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-pie-chart"></i>Employees Target Achievement Chart</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-6 branch-1">
          <div class="tile">
            <h3 class="tile-title">Rabiul Hasan </h3>
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Abdul Halim </h3>
            <div class="embed-responsive embed-responsive-16by9">
         ...
         <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Hasnain Rahman</h3>
            <div class="embed-responsive embed-responsive-16by9">
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Nazrul Islam</h3>
            <div class="embed-responsive embed-responsive-16by9">
      	...
      	datasets: [
      		{
      			...
      			data: [334000, 300340, 100340 ,134000]
      		},
      		{
      			...
      			data: [334000, 200000, 100040, 123400]
      		}
      	]
      };

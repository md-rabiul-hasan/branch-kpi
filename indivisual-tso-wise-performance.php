<?php 
 ...
 <style>
   ...
   <main class="app-content">
    <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Officer-wise performance for a individual branch</h1>
          <p>Showing individual Branch Officer-wise performance </p>
        </div>
    ...
    <div class="row" id="topBranchTsoWisePerformance">
        <div class="col-lg-12 col-md-12 col-sm-12 ">
          <div class="tile">
              <h3 class="tile-title">Top Individual Branch Officer wise Performance (Kawran Bazar Branch)</h3>
              <hr>
    ...
    <div class="row" id="individualBranchTSOPerformance">
        <div class="col-lg-12  col-md-12 col-sm-12" >
          <div class="tile">
              <h3 class="tile-title">Engaging Officer in OSS</h3>
              <hr>
